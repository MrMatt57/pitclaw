...
[![CI](https://github.com/MrMatt57/pit-claw/actions/workflows/ci.yml/badge.svg)](https://github.com/MrMatt57/pit-claw/actions/workflows/ci.yml)
...
```powershell
# Clone the repo
git clone https://github.com/MrMatt57/pit-claw.git
cd pit-claw
